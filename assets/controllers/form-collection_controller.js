...
export default class extends Controller {
    ...
    static values = {
        addLabel: String,
        deleteLabel: String,
        newBtn: 'text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 h-fit',
